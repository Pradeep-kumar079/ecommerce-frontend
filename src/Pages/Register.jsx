      ...
      <form onSubmit={handleSubmit} className="register-form">
        ...
        <div className="container">
              ...
              <div className="right">
                ...
                <input type='number' placeholder='Phone-no' onChange={e => setData({...data,phone:e.target.value})} required />
                <div className="check">
